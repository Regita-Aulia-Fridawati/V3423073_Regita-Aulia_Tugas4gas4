                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="needs-validation" novalidate action="/barang/{{ $barang->id_barang }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="Name Barang" value="{{ old('name', $barang->name) }}"
                                                    required>
                                                @error('name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="price"
                                                    ...
                                                    placeholder="Price" value="{{ old('price', $barang->price) }}" required>
                                                @error('price')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" name="stock"
                                                    ...
                                                    placeholder="Stock" value="{{ old('stock', $barang->stock) }}" required>
                                                @error('stock')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                    ...
                                                    @foreach ($tags as $tag)
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" name="tags[]"
                                                                value="{{ $tag->id_tag }}"
                                                                @if (in_array($tag->id_tag, old('tags', $barang->tags->pluck('id_tag')->toArray()))) checked @endif>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" id="note" class="form-control @error('note') is-invalid @enderror" cols="10"
                                                    rows="5" placeholder="note">{{ old('note', $barang->note) }}</textarea>
                                                @error('note')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
